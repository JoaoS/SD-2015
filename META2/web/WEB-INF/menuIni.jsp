        ...
        <div class="col-md-6">
            <div class="tab-content">
                ...
                <div id="menu3" class="tab-pane fade">
                    ...
                    <p>You have <strong> <c:out value="${fundStarterBean.checkAccountBalance()}"/> </strong>dollars in
                        your account.</p>
                </div>
                ...
                <div id="menu5" class="tab-pane fade">
                    ...
                    <s:form method="post" class="form-horizontal" role="form" action="createProject">
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-4" for="description"> <s:text
                                    name="Description (max. 400 characters)"/></label>
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-4" for="projectDate"> <s:text
                                    name="Date (dd/MM/yyyy HH)"/></label>
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-4" for="targetValue"> <s:text
                                    name="Target value"/></label>
                        ...
                        <div class="input_fields_rewards">
                            <div class="row">
                                <label class="control-label col-sm-3" for="rewardDescriptionList"> <s:text
                                        name="Reward"/></label>

                                <div class="col-sm-3">
                                    <s:textfield name="rewardDescriptionList" class="form-control"/>
                                </div>
                                <label class="control-label col-sm-2" for="minPledgeList"> <s:text
                                        name="Minimum pledge"/></label>
                        ...
                        <div class="input_fields_alternatives">
                            <div class="row">
                                <label class="control-label col-sm-3" for="alternativeDescriptionList"> <s:text
                                        name="Alternative"/></label>

                                <div class="col-sm-3">
                                    <s:textfield name="alternativeDescriptionList" class="form-control"/>
                                </div>
                                <label class="control-label col-sm-2" for="divisorList"> <s:text
                                        name="Divisor*"/></label>
                ...
                <div id="menu6" class="tab-pane fade">
                    ...
                    <div class="row">
                        <s:form action="gotoRewardpageAction" method="post">
                            ...
                            <s:submit type="button" class="btn btn-primary btn-md center-block" id="idReward"
                                      value="Add Reward"/>
                        </s:form>
                    </div>
                    <div class="row">
                    ...
                    <div class=row>
                        <button type="button" class="btn btn-primary btn-block" id="chat-button">Reply to supporter's
                            messages
                        </button>
                    </div>
                </div>
